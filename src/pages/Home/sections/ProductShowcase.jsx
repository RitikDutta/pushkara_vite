...
export default function ProductShowcase() {
  ...
  const buyNowClassName =
    "btn-gold inline-flex w-full items-center justify-center rounded-xl px-5 py-3 text-sm font-semibold sm:w-auto xl:px-5 xl:py-3 xl:text-sm 2xl:px-6 2xl:py-4 2xl:text-base";

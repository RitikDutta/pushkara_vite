          ...
          <div className="md:col-span-2 md:row-span-2">
            ...
            >
              <div className="relative flex h-full items-stretch justify-between gap-6 max-[487px]:gap-4">
                <div className="hero-content flex max-w-xl flex-col justify-center gap-4 p-4 sm:p-6 lg:p-10 max-[487px]:gap-3 max-[487px]:max-w-[240px] max-[487px]:p-3">
                ...
                <div className="hero-image relative flex w-1/2 min-w-[220px] max-w-[280px] items-end justify-center self-stretch pt-4 pr-4 sm:pt-6 sm:pr-6 lg:pt-10 lg:pr-10 sm:max-w-[360px] md:w-[clamp(360px,42vw,600px)] md:min-w-[360px] md:max-w-[600px] max-[487px]:min-w-[180px] max-[487px]:max-w-[220px] max-[487px]:pt-3 max-[487px]:pr-3">

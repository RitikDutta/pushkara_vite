          ...
          <div className="flex flex-col gap-3 py-3 lg:py-2">
            <div className="flex items-center gap-4">
              ...
              <nav className="hidden lg:flex flex-1 items-center justify-center gap-5 text-sm font-medium text-white/90">
                ...
                <NavLink to="/product" className="transition hover:text-white">
                  Shop All
                </NavLink>
                <button className="inline-flex items-center gap-1 transition hover:text-white">
                  Categories
              ...
              <div className="ml-auto hidden items-center gap-3 xl:flex">
                <div className="flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-3 py-1.5 text-xs">
                  <PhoneIcon />
                ...
                <div className="flex items-center gap-2">
                  {["F", "P", "I", "O"].map((letter) => (
                    <span
                      key={letter}
                      className="grid h-8 w-8 place-items-center rounded-full border border-white/20 text-xs font-semibold text-white/90 transition hover:bg-white/10"
                    >
                      {letter}
                    </span>
                  ))}
